...
encode_model = Dense(encoding_dim, activation='relu', kernel_regularizer= regularizers.l1(0.00001))(input_img)
input_layer = BatchNormalization()(encode_model)
# input_layer = Dropout(0.25)(input_layer)
input_layer = Dense(encoding_dim, activation='relu', kernel_regularizer= regularizers.l2(0.00001))(input_layer)
# 레이어 추가
...
input_layer = Dense(encoding_dim, activation='relu', kernel_regularizer= regularizers.l1(0.00001))(input_layer)
input_layer = BatchNormalization()(input_layer)
input_layer = Dense(encoding_dim, activation='relu', kernel_regularizer= regularizers.l2(0.00001))(input_layer)
# 레이어 추가
input_layer = Dense(256, activation = 'relu')(encode_model)
input_layer = Dense(256, activation = 'relu')(input_layer)
input_layer = Dense(256, activation = 'relu')(input_layer)
input_layer = Dropout(0.3)(input_layer)

input_layer = Dense(encoding_dim, activation='relu', kernel_regularizer= regularizers.l1(0.00001))(input_layer)
input_layer = BatchNormalization()(input_layer)
input_layer = Dense(encoding_dim, activation='relu', kernel_regularizer= regularizers.l2(0.00001))(input_layer)
# 레이어 추가
input_layer = Dense(512, activation = 'relu')(encode_model)
input_layer = Dense(512, activation = 'relu')(input_layer)
input_layer = Dense(512, activation = 'relu')(input_layer)
input_layer = Dropout(0.4)(input_layer)
