...
##############모델 구성############
from keras.layers import Input, Dense, BatchNormalization, Dropout, Conv2D, MaxPooling2D, UpSampling2D
...
encode_model = Conv2D(1, (28, 28), activation='relu', padding='same')(input_img)
x = BatchNormalization()(encode_model)
x = Conv2D(64, (2,2), activation='relu', padding='same')(x)
x = Dense(32, activation='relu')(x)
x = Dense(32, activation='relu')(x)
x = Dropout(0.2)(x)
layer_model = Conv2D(1, (28, 28), activation='relu', padding='same')(x)
decode_model = Conv2D(1, (28, 28), activation='sigmoid', padding='same')(layer_model)
...
# 인코딩된 입력을 위한 플레이스 홀더
encode_input = Input(shape=(28,28,1))
